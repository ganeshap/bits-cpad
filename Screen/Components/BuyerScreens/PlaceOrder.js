  ...
  subtotalPrice = () => {
    ...
    if (cartItems) {
      return cartItems.reduce(
        (sum, item) => sum + (item.checked == 1 ? global.var * item.price : 0),
        0,
      );
    }
                ...
                <View
                  ...
                  <View style={[styles.centerElement, {width: 100}]}>
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        this.selectHandler(i, item.checked, item._id)
                      }>
                      <Icon
                        name={
                          item.checked == 1
                  ...
                  <View
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        <Text
                          numberOfLines={1}
                          style={{color: '#8f8f8f', fontSize: 15}}>
                          {item.strength ? item.strength + ' ' + item.unit : ''}
                        </Text>
                        <Text
                          numberOfLines={1}
                          style={{fontSize: 15, color: '#8f8f8f'}}>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View
              ...
              <View
                ...
                <Text
                  style={{fontSize: 18, fontWeight: 'bold', color: '#0faf9a'}}>
