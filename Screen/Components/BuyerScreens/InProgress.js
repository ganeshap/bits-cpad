    ...
    fetch('https://medicine-sheba-server.herokuapp.com/orders/' + order, {
      ...
      .then((responseJson) => {
        ...
        if (responseJson.status == 'success') {
          ...
          alert(
            'OrderNo.' +
              responseJson.message.orderNo +
              '\n' +
              'Address:' +
              responseJson.message.address +
              '\n' +
              'Total: ' +
              responseJson.message.subTotal +
              '\n' +
              'Date:' +
              responseJson.message.dateTime,
          );
        } else if (responseJson.status == 'error') {
          console.log(responseJson.message);
        }
                ...
                <View
                  ...
                  <View
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() => this.orderDetails(item.orderNo)}>
                        <Text
                          numberOfLines={1}
